...
[`@aws-sdk/client-networkmanager`](https://www.npmjs.com/package/@aws-sdk/client-networkmanager/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-networkmanager@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-toMco2i4AIucAJPaO4++PWmNLLggo0h1xMw0hYy86ElZEvOM5XwQTrbHQ3SWgyua
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-networkmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-networkmanager@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-networkmanager@3.687.0/index.min.mjs": "sha384-toMco2i4AIucAJPaO4++PWmNLLggo0h1xMw0hYy86ElZEvOM5XwQTrbHQ3SWgyua"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-networkmanager/blob/refs/tags/3.687.0/LICENSE
```
