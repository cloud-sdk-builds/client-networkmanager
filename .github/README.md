...
[`@aws-sdk/client-networkmanager`](https://www.npmjs.com/package/@aws-sdk/client-networkmanager/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-networkmanager@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0/l7pqNyRCDRGa+lpK8wMXXySp7S1/JVVUucfceKLBTRk/DnL/Zah2R4uJBpP/FX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-networkmanager": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-networkmanager@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-networkmanager@3.948.0/index.min.mjs": "sha384-0/l7pqNyRCDRGa+lpK8wMXXySp7S1/JVVUucfceKLBTRk/DnL/Zah2R4uJBpP/FX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-networkmanager/blob/refs/tags/3.948.0/LICENSE
```
